namespace MachineLearningApplication_Build_2.Services.ReinforcementLearningServices
{
    public class NerualNetworkOptions
    {
        ...
        public List<KeyValuePair<string, string>> HiddenLayerActivationFunction_KVP = [
                ...
                new("hyperbolic_tangent_activation_function", "hyperbolic tangent activation function")
            ];
        ...
        public List<KeyValuePair<string, string>> NewGenerationCreationFunctions_KVP = [
                ...
                new("crossover_weights_mergining", "crossover weights mergining")
            ];
